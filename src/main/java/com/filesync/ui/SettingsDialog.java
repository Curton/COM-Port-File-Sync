...
public class SettingsDialog {
    public void showDialog(JFrame owner, SettingsManager settings, SerialPortManager serialPort, Runnable onSettingsUpdated,
        ...
        okButton.addActionListener(event -> {
            ...
            if (logController != null) {
                logController.log("Settings updated: " + getSettingsString(settings));
            }
            dialog.dispose();
        });
