...
public class TextMergeDialog extends JDialog {
    ...
    public TextMergeDialog(JFrame parent, ConflictInfo conflict) {
        ...
        mainPanel.add(mergePanel, BorderLayout.SOUTH);
        ...
        mergeRadio.addActionListener(e -> {
            ...
            // Pre-populate merge with local content as starting point
            mergeTextArea.setText(conflict.getLocalContentAsString());
            revalidate();
            repaint();
        });
