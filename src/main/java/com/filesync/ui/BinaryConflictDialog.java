...
/**
 * Dialog for resolving binary file conflicts.
 * Shows file info for both versions and allows user to choose which to keep.
 * No content preview is shown since binary files cannot be meaningfully displayed.
 */
